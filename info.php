    ...
    <div class="container">
        <div class="card">
            ...
            <div class="info">
                <div class="shoeName">
                    <div>
                        <h1 class="big">FN SHOES</h1>
                        <span class="new">FNS</span>
                    </div>
                    <h3 class="small">SEPATU LARI PRIA</h3>
                </div>
                ...
                <div class="buy-price">
                    <a href="infoproduk.php" class="buy"><i class="fas fa-shopping-cart"></i>Lihat</a>
                    <div class="price">
